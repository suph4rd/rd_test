...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='position_relations',
            constraint=models.CheckConstraint(check=models.Q(level__lt=6), name='amount_levels'),
        ),
        migrations.AddField(
            model_name='employes',
            name='chief',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.employes'),
        ),
        migrations.AddField(
            model_name='employes',
            name='position',
